  ...
  <section id="list_news">
    ...
    <?php foreach ($news_liste as $news): ?>
      <div class="row">
        ...
        <div class="col-xs-11">
          <h3><a href="<?php echo site_url('personnel/actualite/' . $news['id'] . '-' . str_replace(' ', '-', $news['titre']));?>"><?php echo $news['titre']; ?></a> <br><small><i class="fa fa-calendar" aria-hidden="true"></i> <?php echo $news['date']; ?></small></h3>
        </div>
      </div>
      <br>
    <?php endforeach; ?>
